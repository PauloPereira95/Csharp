            ...
            modelBuilder.Entity("WebApiSnackMachine.Models.Machine", b =>
                {
                    ...
                    b.Property<Guid?>("OrdersIDIntervection")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OrdersIDIntervection");
            ...
            modelBuilder.Entity("WebApiSnackMachine.Models.Product", b =>
                {
                    ...
                    b.Property<Guid?>("OrderIDIntervection")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OrderIDIntervection");
            ...
            modelBuilder.Entity("WebApiSnackMachine.Models.Machine", b =>
                {
                    b.HasOne("WebApiSnackMachine.Models.Orders", null)
                        .WithMany("Machine")
                        .HasForeignKey("OrdersIDIntervection");
                });
            ...
            modelBuilder.Entity("WebApiSnackMachine.Models.Product", b =>
                {
                    b.HasOne("WebApiSnackMachine.Models.Orders", "Order")
                        .WithMany()
                        .HasForeignKey("OrderIDIntervection");
